...
<header class="inner-page">
    ...
    <?php $servicesOne=sp_sql_posts("cid:22;"); $img = json_decode($servicesOne[0]['smeta']); ?>
    
    <?php if(is_array($servicesOne)): foreach($servicesOne as $k=>$vo): $img = json_decode($vo['smeta']); ?>
