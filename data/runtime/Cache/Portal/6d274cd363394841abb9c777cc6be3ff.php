...
<header class="inner-page">
    ...
    <!-- <?php $newsOne=sp_sql_posts("cid:25;"); ?>  -->  
    <?php if(is_array($list)): foreach($list as $k=>$vo): $img = json_decode($vo['smeta']); ?>
        <?php if(($k%2) == 0): ?><section id="services1" class="services"><!-- Section id-->
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 text-side">
                            <a href="http://localhost/index.php?g=&m=News&a=newInfo&id=<?php echo ($vo["object_id"]); ?>">
                                <div class="section-title inside-page">
                                    <h4><?php echo ($vo["post_title"]); ?></h4>
                                    <h2><?php echo ($vo["post_excerpt"]); ?></h2>
                                </div>
                                <div class="ser-content">
                                    <p class="fs-16"><?php echo ($vo["post_content"]); ?></p>
                                </div>
                            </a>                    
                        </div>
                        <div class="col-md-6 col-sm-6 img-side">
        ...
        <?php else: ?>
            <section id="services2" class="services"><!-- Section id-->
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 img-side">
                            <div class="row about-img">
    ...
    <section id="services2" class="services text-center">
    <?php echo ($page); ?>
    </section>
    <!-- Footer Section -->
     <!-- Footer Section -->
    ...
    <footer id="footer" class="footer"><!-- Section id-->
        ...
        <div class="copyright clearfix">
            <div class="">
                <p class="copy">Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
            </div>
        </div>
    </footer>
