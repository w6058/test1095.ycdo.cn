...
<html lang="en">
  ...
  <body id="page-top" class="gallery-page">
...
<header class="inner-page">
    ...
    <section id="gallery" class="gallery"><!-- Section id-->
        <div class="container">
            <div class="row no-gutter popup-gallery">
            <?php $galleryOne=sp_sql_posts("cid:23;"); ?>
            <?php if(is_array($galleryOne)): foreach($galleryOne as $k=>$vo): $img = json_decode($vo['smeta']); ?>
                <div class="col-lg-4 col-sm-4">
                    <a href="<?php echo ($img->photo[0]->url); ?>" class="gallery-box" rel="alternate"><!-- full image -->
                        <img src="<?php echo ($img->photo[0]->url); ?>" class="img-responsive" alt=""><!-- thumb image -->
